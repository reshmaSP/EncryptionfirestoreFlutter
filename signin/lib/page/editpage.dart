...
@override
  void initState() {
    ...
    _user_gender.value = TextEditingValue(text: widget.employee!.gender.toString());
    _user_address.value = TextEditingValue(text: widget.employee!.address.toString());
    _user_contact.value = TextEditingValue(text: widget.employee!.contactno.toString());
